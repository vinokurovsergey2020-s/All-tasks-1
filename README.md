...
Ученику 7 класса ”Б” Васе очень не нравится решать примеры, зато ему нравится программирование. Но пока он не очень хорошо разбирается в нем. Помогите Васе в трудной ситуации и напишите программу, которая решит следующий пример: x _ y + 5 _ z + x - 1, где x = 2, y = 22, z = 0 и выведет результат на экран.
...
y: 22;
z: 0.
Вычислите ответ для примера x _ y + 5 _ z + x - 1 и запишите его в переменную result;
